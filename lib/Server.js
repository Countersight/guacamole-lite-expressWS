...
const expressWs = require('express-ws'); //Types aren't defined in this file but this is the format used
const Ws = require('ws');
...
class Server extends EventEmitter {
    ...
    constructor(wsOptions, guacdOptions, clientOptions, callbacks) {
        ...
        if (wsOptions.hasOwnProperty('app')) {
            ...
            this.clientOptions.log.stdLog(`Setting up guacamole websocket route`);
        ...
        this.clientOptions.log.stdLog(`Server started up, listening on endpoint '/guacamole'`);
    }
